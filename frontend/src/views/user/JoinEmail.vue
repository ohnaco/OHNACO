    ...
    <div class="join_form">
      ...
      <div class="join_box">
        ...
        <div class="back_next_btn">
          <!-- 이전 : 회원가입 메인 페이지 -->
          <button class="page_btn" @click="goJoin">
            <svg
              width="59"
              height="22"
              viewBox="0 0 59 22"
          ...
          <!-- 다음 : 회원가입 프로필 페이지 -->
          <button class="page_btn" @click="goJoinProfile">
            <svg
              width="56"
              height="22"
              viewBox="0 0 56 22"
        ...
        <div class="join_footer_text">
          이메일을 받지 못하셨나요?
          <button class="send_email_again" @click="send_again">재전송</button>
        </div>
      </div>
    </div>
  </div>
